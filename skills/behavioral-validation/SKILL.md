...
| :-: | :--- | :--- | :--- |
| 1 | **Functionality** | Do core module features, custom classes, procedural hooks, entities, Views, and UI actions produce equivalent outcomes? | Execution test output or automated assertion. |
